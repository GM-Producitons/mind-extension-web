  ...
  return (
    <div className="min-h-screen bg-background p-3 sm:p-6">
      ...
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        ...
        <span className="text-base sm:text-xl font-semibold text-foreground">{formattedDate}</span>
        <button
      ...
      {/* To-do's Section */}
      <TodoSection selectedDate={selectedDate} onTodosLoaded={handleTodosLoaded} />
